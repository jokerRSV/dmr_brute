...
sudo apt update
sudo apt install libpulse-dev pavucontrol libsndfile1-dev libfftw3-dev liblapack-dev socat libusb-1.0-0-dev libncurses5 libncurses5-dev libusb-1.0-0-dev cmake git wget make build-essential libitpp-dev libncursesw5-dev
